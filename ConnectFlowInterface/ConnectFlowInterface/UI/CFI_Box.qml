...
T.Control
{
    ...
    /**
    * Box proxy
    *@note This component will auto-create a new c++ CFI_BoxProxy instance
    */
    BoxProxy
    {
        id: bpBoxProxy
    ...
    Rectangle
    {
        ...
        */
        CFI_Connector
        {
            ...
            m_Position:    CFI_Connector.IEPosition.IE_P_Left
        ...
        */
        CFI_Connector
        {
            ...
            // advanced properties
            m_Box:         rcConnectors.parent
            m_Position:    CFI_Connector.IEPosition.IE_P_Top
            m_ScaleFactor: ctBox.m_ScaleFactor;
        }
        ...
        */
        CFI_Connector
        {
            ...
            // advanced properties
            m_Box:         rcConnectors.parent
            m_Position:    CFI_Connector.IEPosition.IE_P_Right
            m_ScaleFactor: ctBox.m_ScaleFactor;
        }
        ...
        */
        CFI_Connector
        {
            ...
            // advanced properties
            m_Box:         rcConnectors.parent
            m_Position:    CFI_Connector.IEPosition.IE_P_Bottom
            m_ScaleFactor: ctBox.m_ScaleFactor;
        }
    }
